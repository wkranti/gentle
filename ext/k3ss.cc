...
//Step 2 : Audio sample rate in Hz
const int arate = 16000;

//Step 3 : Using MFCCs featues
...
//Step 4 : Setting Decoding parameters.
...
int main(int argc , char *argv[])
{
  ...
  // config
    ...
    std::string word_syms_rxfilename = graph_dir + "words.txt";  //Word SymbolTable
    ...
    std::string model_rxfilename = model_dir + "/final.mdl";  // Acoustic Model
    ...
    TransitionModel tmodel_; // This model is trained with online CMVN features
    AmDiagGmm model_;
    {
      bool binary;
...
// This step is similar to what we have done in k3.cc with some edits in line
      char cmd[1024];
